...
2. Get the code:
   ...
   .. code-block:: bash
       ...
       $ git clone git@github.com:VNG-Realisatie/klanten-api klanten
       $ cd klanten
...
``src/klanten/conf/local.py``. You can base this file on the
...
.. code-block:: bash
    ...
    $ python src/manage.py test klanten
...
1. Clone or download the code from `Github`_ in a folder like
   ...
   .. code-block:: bash
       ...
       $ git clone git@bitbucket.org:VNG-Realisatie/klanten-api klanten
       Cloning into 'klanten'...
       ...
...
2. Start the database and web services:
   ...
   .. code-block:: bash
       ...
       $ docker-compose up -d
       Starting klanten_db_1 ... done
       Starting klanten_web_1 ... done
...
3. Create an admin user and load initial data. If different container names
   ...
   .. code-block:: bash
       ...
       $ docker exec -it klanten_web_1 /app/src/manage.py createsuperuser
       Username: admin
       ...
       Superuser created successfully.

       $ docker exec -it klanten_web_1 /app/src/manage.py loaddata admin_index groups
...
.. _Github: https://github.com/VNG-Realisatie/klanten-api/
...
environment variables. See ``src/klanten/conf/docker.py`` for
all settings.
...
.. code-block:: bash
    ...
    $ docker build . && docker run \
        -p 8000:8000 \
        -e DJANGO_SETTINGS_MODULE=klanten.conf.docker \
        -e DATABASE_USERNAME=... \
        -e DATABASE_PASSWORD=... \
        -e DATABASE_HOST=... \
        --name klanten

    $ docker exec -it klanten /app/src/manage.py createsuperuser
