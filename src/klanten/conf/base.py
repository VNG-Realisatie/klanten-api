...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("DB_NAME", "klanten"),
        "USER": os.getenv("DB_USER", "klanten"),
        "PASSWORD": os.getenv("DB_PASSWORD", "klanten"),
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "klanten.utils.context_processors.settings",
            ],
...
WSGI_APPLICATION = "klanten.wsgi.application"
...
DEFAULT_FROM_EMAIL = "klanten@example.com"
EMAIL_TIMEOUT = 10
...
LOGGING = {
    ...
    "handlers": {
        ...
        "project": {
            "level": "DEBUG",
            "class": "logging.handlers.RotatingFileHandler",
            "filename": os.path.join(LOGGING_DIR, "klanten.log"),
            "formatter": "verbose",
            "maxBytes": 1024 * 1024 * 10,  # 10 MB
            "backupCount": 10,
        },
    ...
    "loggers": {
        "klanten": {"handlers": ["project"], "level": "INFO", "propagate": True},
...
AUTHENTICATION_BACKENDS = [
    "klanten.accounts.backends.UserModelEmailBackend",
    "django.contrib.auth.backends.ModelBackend",
]

SESSION_COOKIE_NAME = "klanten_sessionid"

#
# Custom settings
#
PROJECT_NAME = "Klanten"
SITE_TITLE = "Klanten API"
